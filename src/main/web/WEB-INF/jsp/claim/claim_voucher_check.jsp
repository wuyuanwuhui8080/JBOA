...
<head>
		...
		<script type="text/javascript">
			function checkClaimVoucher(checkResult){
		   		...
		   		document.checkResultForm.result.value = "已"+checkResult;
...
<body>
    <div class="action  divaction">
      ...
      <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
      	<s:iterator value="claimVoucher.checkResultList" id="checkResult" status="s">
         <tr>
    ...
    <s:form action="checkResult!checkClaimVoucher.action" name="checkResultForm">
    <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
		<tr>
			<td>
				审批意见：

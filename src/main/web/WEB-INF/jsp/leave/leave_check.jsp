	...
	<head>
		...
		<script type="text/javascript">
			function checkLeave(status){
		   		...
		   		document.leaveForm.status.value = "已"+status;
		...
		<div class="action  divaction">
			...
			<div class="pages">
				...
				<table width="90%" border="0" cellspacing="0" cellpadding="0"
					...
					<tr>
						<td width="36%">
							姓名：<s:property value="leave.sysEmployeeByCreateSn.name"/>
						</td>
						<td width="64%">
							部门：<s:property value="leave.sysEmployeeByCreateSn.sysDepartment.name"/>
						</td>
					</tr>
					<tr>
						<td>
				...
				<s:form action="leave!checkLeave.action" name="leaveForm">
				<table width="90%" border="0" cellspacing="0" cellpadding="0"
					class="addform-base">
					<tr>
						<td>
					...
					<tr>
						<td colspan="4" class="submit">
							...
							class="submit_01" onclick="checkLeave('审批')" />
							<s:hidden id="leaveId" name="leave.id" value="%{leave.id}"/>
							<s:hidden id="status" name="leave.status" value=""/>
							<input type="button" name="button" value="打回"
							class="submit_01" onclick="checkLeave('打回')" />
						</td>
					</tr>
